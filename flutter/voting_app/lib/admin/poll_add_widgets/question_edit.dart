...
class QuestionEditState extends State<QuestionEdit> {
  ...
  @override
  Widget build(BuildContext context) { //EdgerInsets.only is the padding issue
    return Padding(key: widget.key, padding: const EdgeInsets.only(left: 12, right: 12), child: Container(
